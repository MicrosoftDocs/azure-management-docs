...
On general-purpose Azure Linux, verify package versions and changelogs as needed:
...
Azure Linux and Azure Container Linux support common vulnerability scanning tools. See [Security and compliance overview](./security-overview.md) for a list of supported scanners.
