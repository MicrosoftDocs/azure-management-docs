---
title: "Tutorial: Enable Telemetry and Monitoring for your Azure Linux with OS Guard (Preview) Cluster"
description: In this Azure Linux tutorial, you learn how to enable telemetry and monitoring for your Azure Linux with OS Guard (preview) cluster.
author: kavyamsft
...
> [!div class="nextstepaction"]
> [Upgrade Azure Linux with OS Guard nodes](./tutorial-upgrade-os-guard-nodes.md)
