...
- If you don't already have kubectl installed, install it through Azure CLI using the [`az aks install-cli`](/cli/azure/aks#az-aks-install-cli) command or follow the [upstream instructions](https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/).
