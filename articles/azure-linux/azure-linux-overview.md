...
| **[Azure Linux on Windows Subsystem for Linux (WSL)](./windows-subsystem-for-linux-overview.md)** | Local development and learning | Run Azure Linux natively on Windows through Windows Subsystem for Linux (WSL) without requiring a dedicated VM or dual-boot configuration. Azure Linux on WSL provides a lightweight, fast-starting environment for application development, scripting, container workflows, and learning Azure Linux. |
