...
#customer intent: As a user, I want to create a connected registry using the Azure portal so that I can synchronize images and other artifacts with the cloud registry.
---
