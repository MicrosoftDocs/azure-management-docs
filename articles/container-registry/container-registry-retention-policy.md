...
>
> Untagged manifests that use the media type `application/vnd.oci.image.index.v1+json` are not supported by the retention Policy. Only v2 manifests are supported.
