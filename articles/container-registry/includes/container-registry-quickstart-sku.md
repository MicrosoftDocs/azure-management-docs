...
---
> [!TIP]
> In this quickstart, you create a *Standard* registry, which is sufficient for most Azure Container Registry workflows. For increased storage and image throughput, and capabilities such as connection using a [private endpoint](../container-registry-private-link.md), choose the **Premium** pricing plan option (SKU). For details on available service tiers (SKUs), see [Azure Container Registry SKU features and limits](../container-registry-skus.md).