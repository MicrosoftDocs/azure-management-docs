...
For managing repository permissions without Entra, use [non-Entra token-based repository permissions](container-registry-token-based-repository-permissions.md) instead.
