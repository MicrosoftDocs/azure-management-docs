...
* Your identity must have Microsoft Entra permissions to read from the source registry (Reader role) and to import to the target registry (`Container Registry Data Importer and Data Reader` role).
