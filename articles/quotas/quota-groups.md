...
- Available only for Enterprise Agreement or Microsoft Customer Agreement and Internal subscriptions. [Azure Dev/Test subscriptions](/azure/devtest/offer/overview-what-is-devtest-offer-visual-studio) are not supported.
