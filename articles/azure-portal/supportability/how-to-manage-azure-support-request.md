...
> [!NOTE]
> Portal always allow only one file to be uploaded during case creation. A second upload overrides the first one. After case creation, you can go to the support ticket page and upload up to 5 files.
