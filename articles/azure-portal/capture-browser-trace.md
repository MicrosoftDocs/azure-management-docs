...
ms.date: 01/10/2025
ms.topic: how-to
# Customer intent: "As an IT support specialist, I want to capture a browser trace for troubleshooting issues in the Azure portal, so that I can provide detailed information to Microsoft support to resolve the problem effectively."
---
