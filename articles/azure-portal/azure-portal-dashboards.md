...
ms.topic: how-to
ms.date: 10/04/2024
# Customer intent: As a cloud administrator, I want to create and customize dashboards in the cloud portal so that I can efficiently monitor resources and facilitate quick access to tasks related to my projects and organizational roles.
---
