...
ms.date: 03/04/2025
# Customer intent: As a cloud administrator, I want to create a customized dashboard in the Azure portal using PowerShell, so that I can monitor and manage my cloud resources efficiently.
---
