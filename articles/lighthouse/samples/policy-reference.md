...
- See built-in policies in the [Azure Policy GitHub repo](https://github.com/Azure/azure-policy).
- Review the [Azure Policy definition structure](/azure/governance/policy/concepts/definition-structure-basics).
- Review [Azure Policy definitions effects](/azure/governance/policy/concepts/effect-basics).
