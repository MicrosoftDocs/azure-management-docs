...
# Customer intent: "As a cloud administrator onboarding customers to a resource management platform, I want to create eligible authorizations with just-in-time role elevation, so that I can control privileged access while minimizing security risks associated with permanent role assignments."
---
