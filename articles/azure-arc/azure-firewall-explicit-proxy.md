...
ms.date: 04/22/2025
ms.topic: how-to
# Customer intent: "As a network administrator, I want to configure Azure Firewall as an Explicit Proxy for Azure Arc resources, so that I can securely route traffic without exposing my on-premises environment to the public internet."
---
