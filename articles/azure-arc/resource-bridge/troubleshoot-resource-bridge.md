...
1. You may also need to ensure that Azure CLI is able to work behind a proxy. For detailed instructions, refer to the [Azure CLI proxy troubleshooting guide](/azure/use-azure-cli-successfully-troubleshooting.md#work-behind-a-proxy).
