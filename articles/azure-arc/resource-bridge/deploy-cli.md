...
# Customer intent: As a DevOps engineer, I want to use Azure CLI commands for deploying and managing the Arc resource bridge, so that I can integrate on-premises resources with Azure for better hybrid cloud management.
---
