...
The following table lists some of the key VM extensions that are available for Azure Arc-enabled servers running Windows. For more information about the supported OS for the extension, see the "supported OS" link in the table below. For usage and deployment information, see the "additional information" links.
...
The following table lists some of the key VM extensions that are available for Azure Arc-enabled servers running Linux. For more information about the supported OS for the extension, see the "supported OS" link in the table below. For usage and deployment information, see the "additional information" links.
