...
|**Security** | [Microsoft Defender for Servers](/azure/defender-for-cloud/defender-for-servers-overview) provides comprehensive security for Azure Arc-enabled servers and Azure VMs, replacing Configuration Manager's Endpoint Protection capabilities:<ul><li>Integration with Microsoft Defender for Endpoint for threat detection and endpoint protection</li><li>Vulnerability assessment and management to discover and mitigate security vulnerabilities</li><li>Security alerts and threat protection to detect and respond to anomalous activities</li><li>File Integrity Monitoring to track changes to critical files and configurations</li><li>Just-in-time VM access to reduce attack surface</li></ul>Defender for Servers is available for both Azure Arc-enabled servers and Azure VMs, with Plan 1 and Plan 2 tiers offering different feature sets.|
