...
|Update the Azure connected machine agent | The Arc agent should be updated as new versions are released. You can manually update the agent or [enable auto-update (public preview)](manage-agent.md#enable-automatic-agent-upgrade-preview).| 5-10 minutes |
