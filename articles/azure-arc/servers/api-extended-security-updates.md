...
# Customer intent: As a cloud administrator, I want to programmatically deploy and manage Extended Security Updates licenses for Windows Server 2012 through Azure APIs, so that I can efficiently handle license provisioning, linking, modifying, and unlinking for my virtual machines.
---
