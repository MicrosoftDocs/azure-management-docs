...
Download for [Windows](https://gbl.his.arc.azure.com/azcmagent/1.52/AzureConnectedMachineAgent.msi) or [Linux](manage-agent.md#installing-a-specific-version-of-the-agent)
