...
# Customer intent: As a DevOps engineer, I want to integrate Azure Arc-enabled Kubernetes with GitOps workflows, so that I can streamline configuration management and ensure compliance across multiple Kubernetes clusters efficiently.
---
