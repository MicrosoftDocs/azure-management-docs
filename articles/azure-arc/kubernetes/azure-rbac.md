...
>
> For Azure Kubernetes Service (AKS) clusters, enabled by Azure Arc on Azure Stack HCI 23H2 currently support enabling Azure RBAC only during Kubernetes cluster creation. To create an AKS cluster with Azure RBAC enabled, follow the [Use Azure RBAC for Kubernetes authorization](/azure/aks/hybrid/azure-rbac-23h2) guide. Note that Azure RBAC is not supported for Azure Stack HCI, version 22H2.
