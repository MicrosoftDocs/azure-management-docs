...
- **Supported distributions**: Arc-enabled Kubernetes clusters running Kubernetes 1.27 or later, including: AKS on Azure Local, AKS enabled by Azure Arc, OpenShift Kubernetes Distribution, and VMware Tanzu Kubernetes Grid.
