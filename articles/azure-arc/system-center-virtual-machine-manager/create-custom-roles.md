...
1. On the **Add permissions** or **Exclude permissions** window, search *scvmm* and select **Microsoft.SCVMM**.
...
1. After creating the custom role, you can view, update, and delete custom roles by following these steps:
