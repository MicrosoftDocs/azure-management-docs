...
The inbound and outbound connectivity URL exceptions listed [here](/azure/azure-arc/system-center-virtual-machine-manager/support-matrix-for-system-center-virtual-machine-manager#resource-bridge-networking-requirements) are required to be allowlisted.<br/><br/> A library share with write permission for the SCVMM admin account through which Resource Bridge deployment is going to be performed.|
