...
author: johnmarco
ms.author: johnmarc
# Customer intent: "As an administrator managing Azure Arc-enabled servers, I want to query information about my Arc-enabled servers, so that I can ensure compliance and optimize resource allocation."
---
