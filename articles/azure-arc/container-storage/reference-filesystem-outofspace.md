...
1. Certain storage providers allow for increasing the volume size. If you're using such a storage provider and you have extra space available, you might be able to increase your allocated storage to the EdgeVolume to make all the mirrored blobs fit in the EdgeVolume filesystem.
