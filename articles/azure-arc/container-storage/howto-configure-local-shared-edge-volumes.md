---
title: Configure Local Shared volumes (preview)
description: Learn how to configure Local Shared volumes for Azure Container Storage enabled by Azure Arc (preview).
author: sethmanheim
ms.author: sethm
ms.topic: how-to
ms.date: 09/27/2025
...
# Configure Local Shared volumes (preview)
