---
title: Agentic Layer in Agentic RAG Overview
description: Learn how the agentic layer in Agentic RAG uses agents, knowledge bases, and MCP-connected tools to orchestrate grounded multi-turn AI experiences at the edge.
author: cwatson-cat
ms.author: cwatson
...
- **Flexible deployment** so you can use Agentic RAG with the built-in knowledge layer or with external MCP servers only.
...
Agentic RAG supports two knowledge source kinds:
...
Choose **combined** when you want the full Agentic RAG platform. Choose **agentic** when you already have MCP-accessible knowledge systems and only need the agent runtime and management layer. Choose **knowledge** when your application only needs ingestion and retrieval APIs.
...
- [Deployment prerequisites checklist for Agentic RAG](complete-prerequisites.md)
