...
Acquire an access token from Entra ID using the OAuth 2.0 client credentials flow or authorization code flow. The token must be issued for the Agents and Tools with Foundry Local app registration audience.
