---
title: Monitor Agentic Retrieval in Foundry Local
description: "Learn how to monitor Agentic Retrieval in Foundry Local metrics using Azure Monitor, Azure Managed Grafana, and Azure Arc for better insights."
author: cwatson-cat
ms.author: cwatson
...
ms.custom:
  - build-2025
# Customer intent: As a cloud administrator or DevOps engineer, I want to monitor Agentic Retrieval in Foundry Local metrics using Azure Monitor and Azure Managed Grafana so that I can obtain insights into the performance and health of my edge deployment for better operational management.
---

# Monitor Agentic Retrieval in Foundry Local

Agentic Retrieval publishes metrics to [Azure Monitor](/azure/azure-monitor/fundamentals/overview) to assess the performance of the deployed extension. These metrics are composed of numerical values within a sequential set of time-series data. They offer detailed insights into specific aspects of the extension at a particular point in time.
...
- Review [Agentic Retrieval metrics available for monitoring](observability-metrics.md).

## Review the metrics visualizations

Build a chart with metrics for Agentic Retrieval in the Azure portal or by using Azure Managed Grafana.

#### [Azure portal](#tab/azure-portal)

1. Go to the Extensions blade in the Azure portal: **AKS cluster on Azure Local** > **Settings** > **Extensions**.

1. Select the installed Agentic Retrieval extension:
...
1. Search for and select the **Kubernetes - Azure Arc** resource where Agentic Retrieval is installed.
1. Open **Advanced**.  
...
1. Update the **Resource Name** by adding the following value where you replace the `Extension Name` with the name of the Agentic Retrieval extension:
   ...
   If you don't know the Agentic Retrieval extension name, find it in the Azure portal by going to your **Kubernetes - Azure Arc** resource > **Settings** > **Extensions**. Look for the **Name** where **Type** is **microsoft.arc.rag**.
