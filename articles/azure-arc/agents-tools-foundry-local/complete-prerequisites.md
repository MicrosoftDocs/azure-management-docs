...
| 4 | [Choose your language model](prepare-language-model.md) | Agents and Tools with Foundry Local requires you to choose a language model and set up an OpenAI API-compatible endpoint .   |
