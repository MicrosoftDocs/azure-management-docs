...
| 4 | [Choose your language model](prepare-language-model.md) | Agents and Tools with Foundry Local requires you to language model. Choose a model and set up an OpenAI-compatible LLM endpoint before deployment. See [Choose your language model](prepare-language-model.md). |
