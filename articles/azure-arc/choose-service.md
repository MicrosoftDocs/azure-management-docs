...
| _ |Arc-enabled servers  |Arc-enabled VMware vSphere  |Azure Local  |
|---------|---------|---------|---------|---------|---------|
...
- Procure Extended Security Updates (ESUs) at scale for your Windows Server machines running on other public clouds, private clouds like vCenter managed estates.
