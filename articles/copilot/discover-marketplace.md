...
# Discover Azure Marketplace solutions using Azure Copilot
...
You can ask "**I'm looking for a blockchain solution for managing digital assets. Can you help me find one?**" Azure Copilot provides a curated list of blockchain solutions for your scenario, along with the **Explore Marketplace** button to view more details.
