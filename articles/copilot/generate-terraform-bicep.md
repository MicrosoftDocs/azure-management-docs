...
ms.author: jenhayes
author: JnHs
# Customer intent: As a cloud engineer, I want to generate and customize Terraform and Bicep configurations using an AI tool, so that I can efficiently manage and deploy Azure infrastructure.
---
