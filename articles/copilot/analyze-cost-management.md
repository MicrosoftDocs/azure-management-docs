---
title: Analyze, estimate and optimize cloud costs using Azure Copilot
description: Learn about scenarios where Azure Copilot can use Microsoft Cost Management to help you manage your costs.
ms.date: 04/08/2025
ms.topic: how-to
...
Azure Copilot can help you analyze, estimate and optimize cloud costs. Ask questions using natural language to get information and recommendations based on [Microsoft Cost Management](/azure/cost-management-billing/costs/overview-cost-management).
...
:::image type="content" source="media/analyze-cost-management/cost-management-summarize-costs.png" alt-text="Screenshot of Azure Copilot providing a summary of costs.":::
...
:::image type="content" source="media/analyze-cost-management/cost-management-understand.png" alt-text="Screenshot of Azure Copilot showing details about charges.":::
...
:::image type="content" source="media/analyze-cost-management/cost-management-breakdown-by-meter.png" alt-text="Screenshot of Azure Copilot showing a breakdown of costs by meter.":::
...
:::image type="content" source="media/analyze-cost-management/cost-management-compare.png" alt-text="Screenshot of Azure Copilot comparing costs by service from September to October 2024.":::

You can also get an estimate of upcoming expenses by saying "**Can you forecast my cost by month for the next 3 months?**"

:::image type="content" source="media/analyze-cost-management/cost-management-forecast.png" alt-text="Screenshot of Azure Copilot forecasting costs for a subscription for the next three months.":::
...
:::image type="content" source="media/analyze-cost-management/cost-management-simulation-usage.png" alt-text="Screenshot showing Azure Copilot simulating cost changes for increased GPT-35-Turbo usage.":::
...
- Learn how Azure Copilot can help [reduce storage account costs](improve-storage-accounts.md#reduce-storage-costs).
