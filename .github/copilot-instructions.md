...
- `ai-usage: ai-generated` â€“ AI produced the initial draft with minimal human authorship
- `ai-usage: ai-assisted` â€“ Human-directed, reviewed, and edited with AI support
